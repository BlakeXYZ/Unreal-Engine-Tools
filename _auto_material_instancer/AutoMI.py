...
class my_importTextures_GUI(QtWidgets.QWidget):
        ...
        def __init__(self, parent = None):
                ...
                self.mainWidget = QtUiTools.QUiLoader().load(ui_file_in_subdir)
        ...
        def get_single_selected_material(self):
                ...
                from utils import AutoMI_01_Load_Mat
        ...
        def filter_matExpressions_by_user_selected_paramGroup(self):
                ...
                from utils import AutoMI_02_Load_ParamGroup
...
def openWindow():
        ...
        my_importTextures_GUI.window.setObjectName('toolWindow')
