...
class my_importTextures_GUI(QtWidgets.QWidget):
        ...
        def get_single_selected_material(self):
                ...
                self.LIST_all_texture_paramGroups =   inst_TexParamData.return_LIST_all_texture_paramGroups()
                self.LIST_all_textures =              inst_TexParamData.return_LIST_all_textures()
        ...
        def filter_textures_by_user_selected_paramGroup(self):
                ...
                AutoMI_02_Load_ParamGroup.filter_textures_by_user_selected_paramGroup(self.LIST_all_textures, self.comboBox_LIST_all_texture_paramGroups.currentText())
